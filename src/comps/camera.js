Vue.component("cc-camera", {
  ...
  data: () => ({
    ...
    renderStages: ["Opaque", "Transparent"],
  }),
  methods: {
    T: Editor.T,
    is3DCamera() {
      return this.target._is3D.value;
    },
    alignWithScreen() {
      return this.target.alignWithScreen.value;
    },
    isOrtho: (e) => e.ortho.value,
    _setProperty(e, t) {
      const n = {
    ...
    _cullingMask(e) {
      return !!(this.target.cullingMask.value & (1 << e));
    },
    _cullingMaskChanged(e, t) {
    ...
    _everythingMask() {
      let e = this.target.cullingMask.value;
      for (let t = 0, n = this.groupList.length; t < n; t++) {
        if (!(e & (1 << t))) {
          return false;
        }
      }
    ...
    _clearFlags(e) {
      return !!(this.target.clearFlags.value & (1 << e));
    },
    clearFlagsChanged(e, t) {
    ...
    _renderStages(e) {
      return !!(this.target.renderStages.value & (1 << e));
    },
    renderStagesChanged(e, t) {
