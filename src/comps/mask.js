Vue.component("cc-mask", {
  ...
  methods: {
    isRectType() {
      return this.target.type.value === cc.Mask.Type.RECT;
    },
    isEllipseType() {
      return this.target.type.value === cc.Mask.Type.ELLIPSE;
    },
    isImageStencilType() {
      return this.target.type.value === cc.Mask.Type.IMAGE_STENCIL;
    },
