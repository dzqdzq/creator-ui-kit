Vue.component("points-base-collider", {
  template:
...
const e = {
  dependencies: [
    "packages://inspector/inspectors/comps/physics/points-base-collider.js",
  ],
  template:
    '\n    <points-base-collider :target.sync="target"></points-base-collider>\n  ',
  props: { target: { twoWay: true, type: Object } },
};
Vue.component("cc-physics-chain-collider", e);
Vue.component("cc-polygon-collider", e);
