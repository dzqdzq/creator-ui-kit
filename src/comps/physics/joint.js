Vue.component("cc-physics-joint", {
  template:
...
const n = {
  dependencies: ["packages://inspector/inspectors/comps/physics/joint.js"],
  template:
    '\n    <cc-physics-joint :target.sync="target"></cc-physics-joint>\n  ',
  props: { target: { twoWay: true, type: Object } },
};
Vue.component("cc-distance-joint", n);
Vue.component("cc-revolute-joint", n);
Vue.component("cc-motor-joint", n);
Vue.component("cc-prismatic-joint", n);
Vue.component("cc-rope-joint", n);
Vue.component("cc-weld-joint", n);
Vue.component("cc-wheel-joint", n);
