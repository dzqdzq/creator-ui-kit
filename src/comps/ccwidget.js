Vue.component("cc-widget", {
  dependencies: ["packages://inspector/share/alignment-preview.js"],
  template:
  ...
  computed: {
    ...
    horizontalCenterValues() {
      return this.target.isAbsoluteHorizontalCenter.values.map((t) =>
        this._compose(this.target.horizontalCenter, t)
      );
    },
    verticalCenterValue() {
      return this._compose(
  ...
  methods: {
    ...
    _compose(t, e) {
      ...
      if (this.multi && values.some((t) => values[0] !== t)) {
        return "-";
      }
      value = value || 0;
      e || 100;
    ...
    _changePropValue(t, e) {
      Editor.UI.fire(this.$el, "target-change", {
        bubbles: true,
        detail: { type: t.type, path: t.path, value: t.value },
      });

      Editor.UI.fire(this.$el, "target-change", {
        bubbles: true,
        detail: { type: e.type, path: e.path, value: e.value },
      });
    ...
    _onHorizontalCenterChanged(t) {
      ...
      this._changePropValue(
        this.target.horizontalCenter,
        this.target.isAbsoluteHorizontalCenter
      );
    },
    _onVerticalCenterChanged(t) {
      ...
      this._changePropValue(
        this.target.verticalCenter,
        this.target.isAbsoluteVerticalCenter
      );
    },
    _onTopChanged(t) {
    ...
    _checkWidgetMulti(t) {
      const e = t.values ? t.values : t;
      const [i] = e;
      return !e.every((t) => t === i);
    },
    _checkWidgetInput: (t, e) =>
      e ? t.values.every((t) => t === true) : t.value === true,
  },
});
